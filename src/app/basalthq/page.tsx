...
import BasaltHQNeural from '@/components/BasaltHQNeural';
...
// Theme Color - Basalt Orange
const THEME_COLOR = '#ff6504';

export default function BasaltHQPage() {
    return (
                ...
                <div className="max-w-7xl mx-auto px-6 py-24 space-y-32 relative">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-300 leading-relaxed font-medium max-w-4xl mx-auto">
                            BasaltHQ moves beyond static ERPs to build "Cognitive Enterprises." Our platform digitizes business reality into a "Living Ontology"—objects, actions, and decisions that adapt, learn, and execute at the speed of thought. By mimicking the plasticity of neural networks, we enable businesses to evolve instantaneously.
                        </p>
                    </motion.section>
                    ...
                    >
                        {[
                            ...
                            <motion.div
                                key={i}
                                variants={fadeInUp}
                                className="glass-panel p-6 rounded-2xl border border-white/10 hover:border-[#ff6504]/50 transition-colors text-center"
                            >
