    ...
    return (
        <main className="bg-black text-white min-h-screen relative overflow-hidden font-sans selection:bg-purple-500 selection:text-white">
            ...
            <ParallaxHero
                ...
                color={OSIRIS_PURPLE}
                medallion="https://storage.googleapis.com/tgl_cdn/images/Medallions/OP.png"
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="relative">
                                        ...
                                        <div className="w-64 h-64 flex items-center justify-center">
                                            <img src="https://storage.googleapis.com/tgl_cdn/images/Medallions/OP.png" alt="Osiris Protocol" className="w-40 h-40 object-contain" />
                                        </div>
                                    </div>
                                </div>
                            </div>
