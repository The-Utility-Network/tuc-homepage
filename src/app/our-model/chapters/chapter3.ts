// Chapter 3: The Capability Approach and the Garden of Flourishing
// Color Theme: Emerald (#10B981)

export const chapter3 = {
    id: 'capabilities',
    number: 'III',
    title: 'The Garden of Capabilities',
    subtitle: 'Human Flourishing as the Measure of All Things',
    color: '#10B981',
    sections: [
        {
            heading: 'The Question of Flourishing',
            content: `What does it mean for a human being to flourish? This question, which Aristotle first posed as the problem of eudaimonia, remains the central concern of any philosophy worthy of the name. It is not a question that can be answered once and for all, because human flourishing is not a fixed state but a dynamic process, not a destination but a journey, not a possession but an activity.
...
This enriched understanding of human nature has implications for institutional design. Institutions that assume the worst in people—that rely entirely on incentives and sanctions, that treat workers as resources to be managed rather than persons to be respected—are not only unjust but ineffective. Institutions that appeal to our capacity for meaning, connection, and contribution can achieve outcomes that incentive-based systems cannot.`
        ...
        {
            heading: 'Flourishing in the Digital Age',
            content: `The digital age presents both opportunities and threats for human flourishing. The technologies that now pervade our lives—smartphones, social media, artificial intelligence—have transformed how we work, communicate, learn, and play. This transformation is not neutral; it expands some capabilities while threatening others.
...
The Utility Company positions itself as a participant in this struggle. Our automation serves workers, not owners. Our data practices respect privacy. Our governance structures embody democratic participation. We are not alone in this work, nor do we have all the answers. But we contribute what we can to the construction of a technological future compatible with human flourishing.`
    ...
    pullQuote: 'The truly wealthy society is not the one with the largest reserves but the one in which the greatest number can actualize the greatest range of potentials.'
};
