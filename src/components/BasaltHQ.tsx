...
export default function BasaltHQ() {
    return (
        <section id="BasaltHQ" className="relative py-24 px-6 bg-black/50">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                            Our newest subsidiary, BasaltHQ, brings advanced AI automation to the enterprise.
                            From universal ERPs to voice-enabled customer intelligence, BasaltHQ is
                            defining the future of business operations.
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <a
                                href="https://basalthq.com"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="btn-primary bg-[#ff6504] hover:bg-[#e55a03] border-none"
                                style={{ backgroundColor: '#ff6504' }}
                            >
                                VISIT BASALTHQ.COM
                            </a>
                        </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {products.map((product) => (
                            <div
                                key={product.name}
                                className="glass-panel p-6 rounded-xl border-[#ff6504]/10 hover:border-[#ff6504]/30 transition-colors group"
                            >
                                <div className="text-[#ff6504] mb-4 group-hover:scale-110 transition-transform">
                                    {product.icon}
                                </div>
                                <h3 className="text-white font-bold mb-1">{product.name}</h3>
                                <p className="text-xs font-mono text-[#ff6504]/80 mb-3">{product.desc}</p>
