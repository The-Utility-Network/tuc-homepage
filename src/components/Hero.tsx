        ...
        <section id="hero" className="relative min-h-screen flex items-center justify-center px-6 pt-24">
            <div className="max-w-5xl mx-auto text-center z-10 relative">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0 animate-fadeInUp stagger-3">
                    ...
                    <Link
                        href="/pitch-deck"
                        className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm tracking-wider font-semibold text-[#F54029] border border-[#F54029]/40 rounded-full transition-all duration-300 hover:bg-[#F54029]/10 hover:border-[#F54029]/60 hover:shadow-[0_0_25px_rgba(245,64,41,0.2)]"
                    >
