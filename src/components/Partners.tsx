            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-12">
                    {partnerCategories.map((category) => (
                        <div
                            key={category.name}
                            className="group relative aspect-square glass-panel rounded-xl overflow-hidden cursor-pointer hover:border-[color:var(--hover-color)] transition-all duration-300 flex flex-col items-center justify-center p-4 text-center"
                        ...
                        >
                            ...
                            <div className="relative z-10 block">
                                <p className="text-xs font-bold text-gray-300 group-hover:text-white leading-tight uppercase tracking-wider transition-colors duration-300">
                                    {category.name}
                                </p>
                            </div>
